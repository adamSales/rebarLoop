...
knitr::opts_chunk$set(message=FALSE,warning=FALSE,echo=TRUE,
                        error=FALSE,cache=TRUE,dev='tikz')
@
...
<<exactReplication,echo=TRUE,cache=FALSE>>=
...
<<exactReplicationFalse,echo=TRUE,eval=FALSE>>=
exactReplication <- TRUE
@ 
...
<<librarysEtc,results='hide',cache=FALSE>>=
library(scales)
#library(tidyverse)
library(dplyr)
library(ggplot2)
...
<<fig1,fig.width=6.4,fig.height=2,R.options=list(tikzLatexPackages =c(getOption('tikzLatexPackages'),'\\usepackage{amsmath,amsfonts,amsthm,amssymb,thmtools}','\\usepackage{bm}', readLines('notation.tex')))>>=
p <- comparisons%>%
...
<<fig2,fig.width=6.4,fig.height=2,R.options=list(tikzLatexPackages =c(getOption('tikzLatexPackages'),'\\usepackage{amsmath,amsfonts,amsthm,amssymb,thmtools}','\\usepackage{bm}', readLines('notation.tex')))>>=
