...
<<estimateEffects,results='hide',cache=FALSE>>=
...
<<Table2,results='asis',cache=FALSE>>=
...
<<fig1,cache=FALSE,fig.width=6.4,fig.height=2,R.options=list(tikzLatexPackages =c(getOption('tikzLatexPackages'),'\\usepackage{amsmath,amsfonts,amsthm,amssymb,thmtools}','\\usepackage{bm}', readLines('notation.tex')))>>=
p <- comparisons%>%
...
<<fig2,cache=FALSE,fig.width=6.4,fig.height=2,R.options=list(tikzLatexPackages =c(getOption('tikzLatexPackages'),'\\usepackage{amsmath,amsfonts,amsthm,amssymb,thmtools}','\\usepackage{bm}', readLines('notation.tex')))>>=
...
<<appendix,cache=FALSE>>=
ols <- sapply(levels(dat$problem_set),full,dat=dat,covNames=covNames,simplify=FALSE,
                  methods=c('reloopLin','reloopPoor','reloopPlusLin','reloopPlusPoor','lin','ancova'))
...
tikz('figure/appendixLin.tex',width=6.4,height=4,standAlone=FALSE,packages= c(getOption('tikzLatexPackages'),'\\usepackage{amsmath,amsfonts,amsthm,amssymb,thmtools}'))
print(pLin1)
dev.off()
...
tikz('figure/appendixLinReloop.tex',width=4,height=2,standAlone=FALSE,packages= c(getOption('tikzLatexPackages'),'\\usepackage{amsmath,amsfonts,amsthm,amssymb,thmtools}'))
print(pLin2)
dev.off()
...
tikz('figure/appendixPoor.tex',width=6.4,height=4,standAlone=FALSE,packages= c(getOption('tikzLatexPackages'),'\\usepackage{amsmath,amsfonts,amsthm,amssymb,thmtools}'))
print(pOls1)
dev.off()
...
tikz('figure/appendixOlsReloop.tex',width=4,height=2,standAlone=FALSE,packages= c(getOption('tikzLatexPackages'),'\\usepackage{amsmath,amsfonts,amsthm,amssymb,thmtools}'))
print(pOls2)
dev.off()
...
pOls3 <- ggplot(newcomp,aes(ssMult))+#,fill=exGroup))+
...
tikz('figure/OlsReloop.tex',width=5,height=6,standAlone=FALSE,packages= c(getOption('tikzLatexPackages'),'\\usepackage{amsmath,amsfonts,amsthm,amssymb,thmtools}'))
print(pOls3)
dev.off()
