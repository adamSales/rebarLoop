...
plotfun = function(x, idlabel, plotlabel, addlegend)
    ...
    theplot = theplot + scale_color_manual(labels = c(expression(list(bold(x),"RF")), expression(list(x^r,"LS")), expression(list(tilde(bold(x)),"RF")), expression(list(tilde(bold(x)),"EN"))), values = c("lightblue", "orange", "violet", "black"))
    theplot = theplot + theme(legend.position = c(0.1, 0.12))
