...
* Varies sample size (N)

```{r}
options(warn=-1)  ## Due to recycling warning in rf package
```
...
Ns = c(20,30,40,50,75,100,150,200) # observations
R2ps = c(.25,.75)
R2cs = c(.25,.75)
...
# save results
save(res,file = "results/sampsize_res.RData")
```
