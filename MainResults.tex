...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(filename, "{}r"{}, encoding = encoding): cannot open file 'code/olsFigurePrep.r': No such file or directory}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mutate(., comp = factor(comp, levels = unique(as.character(comp)))): object 'comparisonsLin' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(pLin1): object 'pLin1' not found}}\begin{alltt}
\hlkwd{dev.off}\hlstd{()}
\end{alltt}
\begin{verbatim}
## pdf 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mutate(., comp = factor(comp, levels = unique(as.character(comp)))): object 'comparisonsReloopLin' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(pLin2): object 'pLin2' not found}}\begin{alltt}
\hlkwd{dev.off}\hlstd{()}
\end{alltt}
\begin{verbatim}
## pdf 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mutate(., comp = factor(comp, levels = unique(as.character(comp)))): object 'comparisonsPoor' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(pOls1): object 'pOls1' not found}}\begin{alltt}
\hlkwd{dev.off}\hlstd{()}
\end{alltt}
\begin{verbatim}
## pdf 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mutate(., comp = factor(comp, levels = unique(as.character(comp)))): object 'comparisonsReloopPoor' not found}}\begin{alltt}
