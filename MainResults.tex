...
$\hat{\tau}^{\mathrm{DM}}$,
$\trebar$, and $\hat{\tau}^{\mathrm{SS}}[x^r,\mathrm{LS}]$:
...
Figure \ref{fig:ses2}, comparing $\hat{\tau}^{\mathrm{DM}}$,
$\hat{\tau}^{\mathrm{SS}}[x^r,\mathrm{LS}]$, $\hat{\tau}^{\mathrm{SS}}[\mathbf{x},\mathrm{RF}]$, and $\hat{\tau}^{\mathrm{SS}}[\tilde{\mathbf{x}},\mathrm{EN}]$:
...
##  [1] forcats_0.5.2         tidyr_1.2.0           purrr_0.3.4          
##  [4] tibble_3.1.8          kableExtra_1.3.4      ggplot2_3.4.1        
##  [7] dplyr_1.0.10          estimatr_1.0.0        tikzDevice_0.12.3.1  
## [10] knitr_1.40            xtable_1.8-4          loop.estimator_1.0.0 
...
## [19] munsell_0.5.0        compiler_4.2.2       xfun_0.32           
## [22] pkgconfig_2.0.3      systemfonts_1.0.4    htmltools_0.5.3     
## [25] tidyselect_1.1.2     codetools_0.2-18     randomForest_4.7-1.1
## [28] fansi_1.0.3          viridisLite_0.4.1    withr_2.5.0         
## [31] later_1.3.0          grid_4.2.2           jsonlite_1.8.0      
## [34] gtable_0.3.0         lifecycle_1.0.3      DBI_1.1.3           
## [37] magrittr_2.0.3       cli_3.6.0            stringi_1.7.12      
## [40] farver_2.1.1         xml2_1.3.3           ellipsis_0.3.2      
## [43] generics_0.1.3       vctrs_0.5.2          Formula_1.2-4       
## [46] tools_4.2.2          glue_1.6.2           processx_3.7.0      
## [49] parallel_4.2.2       fastmap_1.1.0        colorspace_2.0-3    
## [52] filehash_2.4-3       rvest_1.0.3
\end{verbatim}
\end{kframe}
\end{knitrout}
