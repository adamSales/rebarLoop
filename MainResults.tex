...
\hlstd{p} \hlkwb{<-} \hlstd{comparisons}\hlopt{%>%}
    \hlkwd{filter}\hlstd{(method1}\hlopt{%in%}\hlkwd{c}\hlstd{(}\hlstr{'ReLOOP'}\hlstd{,}\hlstr{'Rebar'}\hlstd{),}
    \hlstd{method2}\hlopt{%in%}\hlkwd{c}\hlstd{(}\hlstr{'ReLOOPEN'}\hlstd{,}\hlstr{'Rebar'}\hlstd{,}\hlstr{'SimpleDifference'}\hlstd{))}\hlopt{%>%}
...
\begin{alltt}
\hlstd{p} \hlkwb{<-} \hlstd{comparisons}\hlopt{%>%}
    \hlkwd{filter}\hlstd{(method1}\hlopt{%in%}\hlkwd{c}\hlstd{(}\hlstr{'ReLOOPEN'}\hlstd{),}
    \hlstd{method2}\hlopt{%in%}\hlkwd{c}\hlstd{(}\hlstr{'Loop'}\hlstd{,}\hlstr{'ReLOOP'}\hlstd{,}\hlstr{'SimpleDifference'}\hlstd{))}\hlopt{%>%}
...
\hline
$\trcpen$ & $\trc$ & 1 & 10 & 22 & 1.844856 & 25\\
\hline
$\trcpen$ & $\tss[\bx,\mathrm{RF}]$ & 2 & 14 & 17 & 1.400882 & 33\\
\hline
$\trcpen$ & $\trebar$ & 1 & 3 & 29 & 1.905476 & 25\\
\hline
$\trcpen$ & $\tsd$ & 0 & 2 & 31 & 2.314750 & 33\\
\hline
$\trc$ & $\tss[\bx,\mathrm{RF}]$ & 17 & 5 & 11 & 1.266307 & 33\\
\hline
$\trc$ & $\trebar$ & 0 & 19 & 14 & 1.944435 & 2\\
\hline
$\trc$ & $\tsd$ & 0 & 1 & 32 & 2.092385 & 33\\
\hline
$\tss[\bx,\mathrm{RF}]$ & $\trebar$ & 7 & 4 & 22 & 1.926845 & 25\\
\hline
$\tss[\bx,\mathrm{RF}]$ & $\tsd$ & 3 & 0 & 30 & 1.949483 & 25\\
\hline
$\trebar$ & $\tsd$ & 2 & 4 & 27 & 1.848485 & 33\\
\hline
\end{tabular}
...
\hline
$\trcpen$ & $\trc$ & 1.417204 & 14 & 0.9710151 & 2\\
\hline
$\trcpen$ & $\tss[\bx,\mathrm{RF}]$ & 1.142609 & 30 & 0.9088411 & 32\\
\hline
$\trcpen$ & $\trebar$ & 1.888076 & 2 & 0.9692726 & 30\\
\hline
$\trcpen$ & $\tsd$ & 1.927863 & 25 & 1.0132275 & 4\\
\hline
$\trc$ & $\tss[\bx,\mathrm{RF}]$ & 1.150106 & 30 & 0.5360364 & 25\\
\hline
$\trc$ & $\trebar$ & 1.315815 & 4 & 0.9756321 & 30\\
\hline
$\trc$ & $\tsd$ & 1.551418 & 27 & 1.0111747 & 4\\
\hline
$\tss[\bx,\mathrm{RF}]$ & $\trebar$ & 1.914722 & 2 & 0.8482977 & 30\\
\hline
$\tss[\bx,\mathrm{RF}]$ & $\tsd$ & 1.921804 & 27 & 0.9200898 & 30\\
\hline
$\trebar$ & $\tsd$ & 1.506491 & 27 & 0.5403895 & 2\\
\hline
\end{tabular}
